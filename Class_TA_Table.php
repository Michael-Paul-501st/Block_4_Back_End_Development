...
<html lang="en"><!-- The create the html and set lang to english -->
    <head><!-- The head tag for html-->
        <title>Class TA relationship</title><!--The title of the web page -->
    ...
    <main><!-- The main body of the website-->
        ...
        $sql_Class_TA = "INSERT INTO `TA_class` (`TA_ID`, `Class_ID`) VALUES ('".$TA_ID."', '".$Class_ID."');";

        if ($conn->query($sql_Class_TA) === TRUE) {//Add TA class relatshion to the record
            echo "New record created successfully";//return success messsage
        } 
        else {
            echo "Error: " . $sql_Class_TA . "<br>" . $conn->error;//display error message
        }
