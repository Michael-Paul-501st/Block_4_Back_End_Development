...
<html lang="en"><!-- The create the html and set lang to english -->
    <head><!-- The head tag for html-->
        <title>Class ST relationship</title><!--The title of the web page -->
    ...
    <main><!-- The main body of the website-->
        ...
        $sql_Class_ST = "INSERT INTO `st_class` (`ST_ID`, `Class_ID`) VALUES ('".$ST_ID."', '".$Class_ID."');";

        if ($conn->query($sql_Class_ST) === TRUE) {//Add ST class relatshion to the record
            echo "New record created successfully";//return success messsage
        } 
        else {
            echo "Error: " . $sql_Class_ST . "<br>" . $conn->error;//display error message
        }
