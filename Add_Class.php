...
<html lang="en"><!-- The create the html and set lang to english -->
    <head><!-- The head tag for html-->
        <title>Add Class</title><!--The title of the web page -->
    ...
    <main><!-- The main body of the website-->
        ...
        $Class_Capacity =  $_GET["Class_Capacity"];
        $sql_Class = "INSERT INTO `class` (`Class_ID`, `Class_Name`, `Class_Capacity`) VALUES (NULL, '".$Class_Name."', '".$Class_Capacity."');";

        //Add  Class
        if ($conn->query($sql_Class) === TRUE) {//Add Class to the record
            echo "New record created successfully";//return success messsage
        } 
        else {
            echo "Error: " . $sql_Class . "<br>" . $conn->error;//display error message
        }
