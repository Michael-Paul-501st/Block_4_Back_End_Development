...
<html lang="en"><!-- The create the html and set lang to english -->
    <head><!-- The head tag for html-->
        <title>Add Emergency Contact</title><!--The title of the web page -->
    ...
    <main><!-- The main body of the website-->
        ...
        $SEC_phone_number = $_GET["SEC_phone_number"];

        $sql_SEC = "INSERT INTO `emergency_contact` (`SEC_ID`, `SEC_Name`, `SEC_Phone_number`) VALUES (NULL, '".$SEC_Name."', '".$SEC_phone_number."');";

        if ($conn->query($sql_SEC) === TRUE) {//Add SEC to the record
        echo "New record created successfully";//return success messsage
        } 
        else {
        echo "Error: " . $sql_SEC . "<br>" . $conn->error;//display error message
        }
