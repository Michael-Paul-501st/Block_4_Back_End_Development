...
<html lang="en"><!-- The create the html and set lang to english -->
    <head><!-- The head tag for html-->
        <title>Delete Teacher</title><!--The title of the web page -->
    ...
    <main><!-- The main body of the website-->
        ...
        $Teacher_ID =  $_GET["Teacher_ID"];//Get the Teacher iD

        $sql_get_log_in_ID = "SELECT * FROM `Log_in_Teacher` WHERE Teacher_ID = '". strval($Teacher_ID)."';";//get the log in id of the teacher
        ...
        if ($log_in_ID_result ->num_rows > 0){
            while ($row = $log_in_ID_result -> fetch_assoc()){
                ...
                $sql_Delete_log_in_teacher = "DELETE FROM Log_in_Teacher WHERE Teacher_ID = '".$Teacher_ID."';";//delete the relatshion between the log in and teacher
                $sql_Delete_log_in = "DELETE FROM Log_in WHERE Universal_ID = '".$Universal_ID."';";//delete the teacher log in
        ...
        $sql_Delete_teacher = "DELETE FROM Teacher WHERE Teacher_ID = '".$Teacher_ID."';";//delete the teacher
        $sql_Delete_class_Teacher = "DELETE FROM Teacher_Class WHERE Teacher_ID = '".$Teacher_ID."';";//delete the relatshion between class and teacher
        $conn->query($sql_Delete_class_Teacher);
        $conn->query($sql_Delete_teacher);
