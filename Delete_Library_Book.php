...
<html lang="en"><!-- The create the html and set lang to english -->
    <head><!-- The head tag for html-->
        <title>Delete Library book</title><!--The title of the web page -->
    ...
    <main><!-- The main body of the website-->
        ...
        $sql_Delete_Library_Book = "DELETE FROM Library_Book WHERE Library_Book_ID = '".$Library_Book_ID."';";//delete the Library book
        $conn->query($sql_Delete_Library_Book);
