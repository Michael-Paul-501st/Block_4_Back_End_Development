...
<html lang="en"><!-- The create the html and set lang to english -->
    <head><!-- The head tag for html-->
        <title>Delete Class</title><!--The title of the web page -->
    ...
    <main><!-- The main body of the website-->
        ...
        $Class_ID =  $_GET["Class_ID"];//get the class ID

        $sql_Delete_class = "DELETE FROM Class WHERE Class_ID = ".$Class_ID.";";//delete class
        $sql_Delete_class_Teacher = "DELETE FROM Teacher_Class WHERE Class_ID = ".$Class_ID.";";//delete the relashion to the teacher
        $sql_Delete_student_Class = "DELETE FROM Student_Class WHERE Class_ID = ".$Class_ID.";";//delete the relatshion to the student
        $sql_Delete_class_TA = "DELETE FROM TA_Class WHERE Class_ID = ".$Class_ID.";";//delete the relatshion to the TA
        $sql_Delete_class_ST = "DELETE FROM ST_Class WHERE Class_ID = ".$Class_ID.";";//delete the relatshion to the ST
