...
<html lang="en"><!-- The create the html and set lang to english -->
    <head><!-- The head tag for html-->
        <title>Class Teacher relationship</title><!--The title of the web page -->
    ...
    <main><!-- The main body of the website-->
        ...
        $sql_Class_Teacher = "INSERT INTO `teacher_class` (`Teacher_ID`, `Class_ID`) VALUES ('".$Teacher_ID."', '".$Class_ID."');";

        if ($conn->query($sql_Class_Teacher) === TRUE) {//Add Teacher class relatshion to the record
            echo "New record created successfully";//return success messsage
        } 
        else {
            echo "Error: " . $sql_Class_Teacher . "<br>" . $conn->error;//display error message
        }
